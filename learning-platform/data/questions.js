...
const TOPICS = [
  { id: 'sc-chem101', label: '🧪 Skill Check: Chem 101 (AP Bio Prereq — OPEN NOTE)', class: 'Skill Check' },
...
const QUESTIONS = [
  ...
  // Sample questions from notes — helium piston scenarios
  { id:'sc10k', topic:'sc-1.0', q:'A sample of helium gas is in a closed piston at 298 K (diagram a). What change would produce diagram (b), where particles have longer arrows but the same spacing?', options:['Increase temperature at constant volume','Increase temperature at constant pressure','Increase external pressure at constant temperature','Decrease temperature at constant volume'], correct:0, explain:'Longer arrows = faster particles = higher temperature. Same spacing = same volume. So temperature increased while volume stayed constant. The piston is locked (closed) so volume can\'t change.' },
  { id:'sc10l', topic:'sc-1.0', q:'A sample of helium gas is in a closed piston at 298 K (diagram a). What change would produce diagram (c), where particles are spread farther apart with longer arrows?', options:['Increase temperature at constant pressure (volume increased)','Increase temperature at constant volume','Increase external pressure at constant temperature','Decrease pressure at constant temperature'], correct:0, explain:'Longer arrows = higher temperature. Particles spread out = volume increased. At constant pressure, heating a gas causes it to expand (Charles\'s Law). The piston moves freely, so volume increases as temp rises.' },
  { id:'sc10m', topic:'sc-1.0', q:'A sample of helium gas is in a closed piston at 298 K (diagram a). What change would produce diagram (d), where particles are closer together with the same arrow length?', options:['Increase external pressure at constant temperature (volume decreased)','Increase temperature at constant volume','Increase temperature at constant pressure','Decrease pressure at constant temperature'], correct:0, explain:'Same arrow length = same temperature. Particles closer = volume decreased. Increasing external pressure compresses the gas at constant temperature → smaller volume (Boyle\'s Law).' },
  // Conceptual particulate diagram understanding
  { id:'sc10n', topic:'sc-1.0', q:'In a particulate diagram, you see two flasks with the same volume. Flask A has 6 molecules, Flask B has 12 molecules. What can you conclude?', options:['Flask B has double the concentration of Flask A','Flask B has double the temperature of Flask A','Flask B has double the pressure and concentration of Flask A','Flask A has larger molecules'], correct:0, explain:'Concentration = number of particles per volume. Same volume, double the molecules = double the concentration. (Pressure would also double, but the key observable in the diagram is concentration.)' },
  { id:'sc10o', topic:'sc-1.0', q:'In a particulate diagram of an ionic compound dissolving in water, you see water molecules oriented with their oxygen ends pointing toward the cations. Why?', options:['Oxygen has a partial negative charge (δ−) and is attracted to positive cations','Oxygen has a partial positive charge and is attracted to negative ions','Oxygen is larger than hydrogen','Oxygen forms covalent bonds with cations'], correct:0, explain:'Water is polar: O is δ− (more electronegative), H is δ+. Cations are positive → attracted to the negative end (oxygen). Anions are negative → attracted to the positive end (hydrogen). This is solvation.' },

  // ===== SKILL CHECK: AP CHEM 1.1 — MOLES & MOLAR MASS =====
  // Includes EXACT sample questions from the notes (examples 1-5)
  ...
  // EXACT sample questions from notes — Example 1-5
  { id:'sc11e', topic:'sc-1.1', q:'Calculate the mass of 1.50 mol hydrogen gas (H₂). (Molar mass H₂ = 2.02 g/mol)', options:['3.03 g','1.01 g','4.04 g','0.75 g'], correct:0, explain:'mass = moles × molar mass\n  1.50 mol H₂ × (2.02 g H₂ / 1 mol H₂) = 3.03 g H₂\n\nKey: moles → grams, MULTIPLY by molar mass.' },
  { id:'sc11f', topic:'sc-1.1', q:'Calculate the volume of 1.50 mol hydrogen gas at STP.', options:['33.6 L','22.4 L','11.2 L','44.8 L'], correct:0, explain:'volume = moles × 22.4 L/mol (at STP)\n  1.50 mol H₂ × (22.4 L H₂ / 1 mol H₂) = 33.6 L H₂\n\nKey: at STP, 1 mol of ANY gas = 22.4 L. Multiply moles by 22.4.' },
  { id:'sc11g', topic:'sc-1.1', q:'Determine the number of moles in 1.8 × 10²³ molecules of H₂.', options:['0.30 mol','0.15 mol','1.8 mol','6.02 mol'], correct:0, explain:'moles = molecules ÷ Avogadro\'s number\n  1.8×10²³ molecules H₂ × (1 mol H₂ / 6.02×10²³ molecules) = 0.30 mol H₂\n\nKey: particles → moles, DIVIDE by 6.022×10²³.' },
  { id:'sc11h', topic:'sc-1.1', q:'Determine the mass of 4.5 L CO₂ at STP. (Molar mass CO₂ = 44.01 g/mol)', options:['8.8 g','4.4 g','22.4 g','44.0 g'], correct:0, explain:'Two-step: liters → moles → grams\n  Step 1: 4.5 L CO₂ × (1 mol / 22.4 L) = 0.201 mol CO₂\n  Step 2: 0.201 mol × 44.01 g/mol = 8.8 g CO₂\n\nKey: liters → moles (÷22.4), then moles → grams (×molar mass).' },
  { id:'sc11i', topic:'sc-1.1', q:'How many atoms are in 100.0 g Mg? (Molar mass = 24.31 g/mol)', options:['2.4 × 10²⁴ atoms','1.2 × 10²⁴ atoms','4.1 × 10²⁴ atoms','6.02 × 10²³ atoms'], correct:0, explain:'Two-step: grams → moles → atoms\n  Step 1: 100.0 g Mg × (1 mol / 24.31 g) = 4.114 mol Mg\n  Step 2: 4.114 mol × 6.02×10²³ atoms/mol = 2.4×10²⁴ atoms Mg\n\nKey: grams → moles (÷molar mass), then moles → atoms (×6.022×10²³).' },
